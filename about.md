...
<p>My academic background is in humanities, and I began my corporate career in HR. Then, I <i>accidentally landed</i> in IT when the firm was under restructuring. I thought it would only be a clash landing without ever realizing this would later become a <strong>fateful pivot</strong> in my life.</p>
...
<br>Working in the tech industry means participating in the connection journey. A girl who studied human languages, history, and social interactions is now learning programming languages and the exchange of frameworks and tools.The unique changeover is an excellent example of connecting and bridging differences - this mentality would be, citing the words of <i>Jean-Paul Sartre</i>, the <i>raison d'être</i> of technology.</p>

<h4> ...and why Testing?</h4>
<p>Testing will be an excellent fit for me. The job represents me very well: The combination of non-tech soft skills & tech-savvy hard skills, attention to detail for verification and evaluation, process-oriented work manner, thorough documentation, and communication. Contribution to better quality is a gratifying part of this job, and I want to play a role in the continuous improvement of applications. Putting <strong>ISTQB Certification</strong> under my belt, I am interested in <strong>Mobile Application Testing</strong> and <strong>Test Automation</strong> for further specialization.</p>
